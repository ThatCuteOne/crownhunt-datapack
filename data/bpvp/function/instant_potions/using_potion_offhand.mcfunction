...
data modify storage bpvp:temp custom_effects set from entity @e[tag=bpvp.temp,limit=1] equipment.head.components.minecraft:potion_contents.custom_effects
