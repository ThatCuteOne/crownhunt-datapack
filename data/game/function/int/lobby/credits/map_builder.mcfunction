execute if score sequence lobby.credits matches ..0 run scoreboard players set sequence lobby.credits 9

execute if score sequence lobby.credits matches 8 run summon text_display ~ ~ ~ {Rotation:[90f,0f],teleport_duration:2,billboard:"fixed",alignment:"center",Tags:["lobby.credits_display","new"],text:{"color":"gold","font":"game:small_caps","text":"-----Map builders-----"}}

execute if score sequence lobby.credits matches 7 run summon text_display ~ ~ ~ {Rotation:[90f,0f],teleport_duration:2,billboard:"fixed",alignment:"center",Tags:["lobby.credits_display","new"],text:{"color":"dark_aqua","font":"game:small_caps","text":"ru_bl"}}
...
execute if score sequence lobby.credits matches 6 run summon text_display ~ ~ ~ {Rotation:[90f,0f],teleport_duration:2,billboard:"fixed",alignment:"center",Tags:["lobby.credits_display","new"],text:{"color":"dark_aqua","font":"game:small_caps","text":"ThatCuteOne"}}
...
execute if score sequence lobby.credits matches 5 run summon text_display ~ ~ ~ {Rotation:[90f,0f],teleport_duration:2,billboard:"fixed",alignment:"center",Tags:["lobby.credits_display","new"],text:{"color":"dark_aqua","font":"game:small_caps","text":"sujuxi"}}
...
execute if score sequence lobby.credits matches 3 run summon text_display ~ ~ ~ {Rotation:[90f,0f],teleport_duration:2,billboard:"fixed",alignment:"center",Tags:["lobby.credits_display","new"],text:{"color":"dark_aqua","font":"game:small_caps","text":"Abomat"}}
...
execute if score sequence lobby.credits matches 2 run summon text_display ~ ~ ~ {Rotation:[90f,0f],teleport_duration:2,billboard:"fixed",alignment:"center",Tags:["lobby.credits_display","new"],text:{"color":"dark_aqua","font":"game:small_caps","text":"Silberhecht"}}
...
execute if score sequence lobby.credits matches 1 run summon text_display ~ ~ ~ {Rotation:[90f,0f],teleport_duration:2,billboard:"fixed",alignment:"center",Tags:["lobby.credits_display","new"],text:{"color":"dark_aqua","font":"game:small_caps","text":"Lyne100"}}
