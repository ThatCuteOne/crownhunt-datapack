...
item replace entity @s armor.head with carved_pumpkin[custom_name='{"color":"gold","italic":false,"text":"Crown of Time"}',custom_model_data=200,custom_data={star:1b},enchantments={levels:{"minecraft:binding_curse":1},show_in_tooltip:false},enchantment_glint_override=false] 1
tag @s add has_star
