...
item replace entity @s armor.head with carved_pumpkin[custom_name={"color":"gold","italic":false,"text":"Crown of Time"},item_model="game:crown/star_crown",custom_data={star:1b},enchantments={"minecraft:binding_curse":1},enchantment_glint_override=false,tooltip_display={hidden_components:["enchantments"]}] 1
tag @s add has_star
