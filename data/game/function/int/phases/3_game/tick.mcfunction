...
# advancements
execute as @a[tag=game.in_game,scores={kit.id=0}] if score @s gamemode.advancements.archer_arrows_shot matches 16.. run advancement grant @s only game:kit/common/no_arrows_archer
...
execute as @a[tag=game.in_game] as @s[scores={kit.id=11}] if items entity @s weapon.mainhand creeper_spawn_egg run item modify entity @s weapon.mainhand game:layout/add_can_place
execute as @a[tag=game.in_game] as @s[scores={kit.id=11}] if items entity @s weapon.offhand creeper_spawn_egg run item modify entity @s weapon.offhand game:layout/add_can_place
