...
execute if score temp temp matches ..1 run item replace entity @s[team=!Red] hotbar.3 with carrot_on_a_stick[custom_data={navigator:{action:{command:"function navigator:interface/pages/1/110/join_red"}}},custom_name='{"color":"red","italic":false,"text":"Join Red Team","font":"game:small_caps"}',custom_model_data=30000]
...
execute if score temp temp matches ..1 run item replace entity @s[team=!Blue] hotbar.5 with carrot_on_a_stick[custom_data={navigator:{action:{command:"function navigator:interface/pages/1/110/join_blue"}}},custom_name='{"color":"blue","italic":false,"text":"Join Blue Team","font":"game:small_caps"}',custom_model_data=30040]
...
item replace entity @s hotbar.4 with carrot_on_a_stick[custom_data={navigator:{action:{command:"function navigator:interface/pages/1/110/join_spectator"}}},custom_name='{"color":"light_purple","italic":false,"text":"Join Spectator","font":"game:small_caps"}',custom_model_data=110400]
